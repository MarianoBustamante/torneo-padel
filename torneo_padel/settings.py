"""
Django settings for torneo_padel project.
...
SECRET_KEY = 'django-insecure-$hs!prppswoht-*h_lox2u_wm3vxlh!xl!y60d+jhgfgr7hc+5'
...
ROOT_URLCONF = 'torneo_padel.urls'
...
SESSION_COOKIE_AGE = 1209600  # (Opcional) Sesión dura 2 semanas
